...
export default function VenueMap() {
  ...
  // Google Maps URL for Sea Garden - Ain Alhayat Resort
  const googleMapsUrl =
    "https://maps.app.goo.gl/pQ1Jq9Tw2ExrWA3t5?g_st=ic"
        ...
        <div className="relative group">
          ...
          <div className="mt-6 text-center px-4">
            <h3 className="text-xl sm:text-2xl font-serif font-medium text-foreground mb-2">
              {isRTL ? 'سي جاردن' : "Sea Garden"}
            </h3>
            <div className="text-muted-foreground text-sm sm:text-base mb-3 space-y-1">
              {isRTL ? (
                <>
                  <div>منتجع عين الحياة</div>
                </>
              ) : (
                <>
                  <div>Ain Alhayat Resort</div>
                </>
              )}
            </div>
